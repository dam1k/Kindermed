...
function Footer() {
    ...
    return (
        <>
            <div
                className="text-[#fff] !pt-[100px] lg:!pt-[125px] bg-[#161616] max-[1023px]:px-[10px] container !pb-[100px] lg:!pb-[125px] grid-cols-1 grid min-[1400px]:grid-cols-2 gap-x-[25px] gap-y-[40px] min-[1400px]:gap-y-[85px]">
                <div>
                ...
                <div className="max-[1023px]:pl-[0] max-[1599px]:pl-[150px] min-[1600px]:pl-[250px]">
                    <iframe className="!rounded-[23px] !overflow-hidden"
                            ...
                            width={width < 1024 ? "100%" : 500} height={width < 1024 ? 215 : 300} loading="lazy"
                    ...
                    <div className="pt-[12px] lg:pl-[17px] lg:pt-[17px] flex flex-col gap-[50px]">
                        ...
                        <div className="flex gap-[10px]">
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent
                                    className="bg-[#2B2B2B] flex flex-col gap-[7px] !mt-[14px] !border-0 px-[17px] py-[13px] rounded-[20px]">
                                    {busDirections.map((busDirection: busDirection, i: number) => {
                                        return <DropdownMenuLabel className="p-0 justify-between flex" key={i}>
                ...
                <div className="grid grid-cols-1 min-[1450px]:grid-cols-2 gap-[12px] max-[1449px]:gap-y-[50px]">
                    <div className="flex flex-col gap-[75px]">
                        <div>
                            <div className="flex gap-[8px]">
                                <Image width={21} height={21} alt="" src="/icons/ArrowNarrow.svg"/>
                                <h3 className="uppercase !text-[#fff] text-[20px] leading-[21px]">Programează-te
                                    online</h3>
                            </div>
                            <p className="text-[#fff]/[0.5] w-[315px] mt-[17px] leading-[145%]">Lăsați-ne datele Dvs. de
                                contact, iar
                    ...
                    <div className="">
                        ...
                        <div className="w-full max-[1024px]:w-full max-[1450px]:w-[400px] flex mt-[20px] gap-[8px] flex-wrap content-start items-start">
                            {phoneNumbers.map((phoneNumber: phoneNumber, i: number) => {
                                return <Link key={phoneNumber.phone}
                                             href={i === 3 && phoneNumber.viber ? `viber://chat?number=%2B${phoneNumber.viber}` : `tel:${phoneNumber.href}`}
                                             className="leading-[105%] flex px-[17px] py-[12px] gap-[10px] items-center border-[1px] rounded-[15px] !border-[#fff]/[0.4] !text-[#fff]">
                                    <Image width={17} height={17} alt=""
                ...
                <div className="max-[1023px]:hidden w-[430px] flex gap-x-[55px] gap-y-[25px] flex-wrap content-start items-start">
                    {footerLinks.map((link: navLink) => {
                        return <Link key={link.href} className="text-[#fff] flex items-center gap-[5px] leading-[105%]"
                                     href={link.href}>
                            <span>{link.text}</span>
            ...
            <div className="max-[1024px]:hidden bg-[#121212] gap-[15px] py-[45px] flex-col flex items-center">
                ...
                <Link target="_blank" className="!text-[#fff]/[0.15] flex gap-[10px] items-center" href="https://dreamsite.md">Developed by
                    <Image width={12.65} height={29} src="/icons/DreamSiteLogo.svg" alt=""/>
                </Link>
            </div>
        </>
    );
